...
SECRET_KEY = 'django-insecure-)tx0-0z3s!o2=k$kbruifrm43&#x!n)3jn^9hjt-%-#m&3ikh('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://smart-care-1-9mpj.onrender.com/','https://*.127.0.0.1']
...
EMAIL_HOST_PASSWORD = env("EMAIL_PASSWORD")  # Replace with App Password (for Gmail)
